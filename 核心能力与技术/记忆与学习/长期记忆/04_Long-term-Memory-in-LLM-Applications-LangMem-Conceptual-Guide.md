# Long-term Memory in LLM Applications (LangMem Conceptual Guide)

**来源**: [https://langchain-ai.github.io/langmem/concepts/conceptual_guide/](https://langchain-ai.github.io/langmem/concepts/conceptual_guide/)

---

# Core Concepts

原文链接: https://langchain-ai.github.io/langmem/concepts/conceptual_guide/

# Long-term Memory in LLM Applications[¶](#long-term-memory-in-llm-applications "Permanent link")
...
## Types of Memory[¶](#memory-types "Permanent link")
...
### Semantic Memory: Facts and Knowledge[¶](#semantic-memory-facts-and-knowledge "Permanent link")
...
![Collection update process](ai-leaders-insights/核心能力与技术/记忆与学习/长期记忆/images/db1a2cf3ed36c6465689190566c81779.png)

Extracting semantic memories as collections

Setup

*API: [create\_memory\_manager](https://langchain-ai.github.io/langmem/reference/memory/#langmem.create_memory_manager)*
...
![Profile update process](ai-leaders-insights/核心能力与技术/记忆与学习/长期记忆/images/03a7a99040ffca98116085ae8a8b2ab9.png)
...
### Episodic Memory: Past Experiences[¶](#episodic-memory-past-experiences "Permanent link")
...
### Procedural Memory: System Instructions[¶](#procedural-memory-system-instructions "Permanent link")
...
![Instructions update process](ai-leaders-insights/核心能力与技术/记忆与学习/长期记忆/images/99bc95f7681e8aaea6ef8de6b104568c.png)

Optimizing prompts based on feedback

Setup

*API: [create\_prompt\_optimizer](https://langchain-ai.github.io/langmem/reference/prompt_optimization/#langmem.create_prompt_optimizer)*
...
![Hot path vs background memory processing](ai-leaders-insights/核心能力与技术/记忆与学习/长期记忆/images/da326827964891c9c8a42be1814db0af.png)

### Conscious Formation[¶](#conscious-formation "Permanent link")
...
Check out the ["hot path" quickstart](../../hot_path_quickstart/) for an example of how to use this technique.

### Subconscious Formation[¶](#subconscious-formation "Permanent link")
...
Check out the ["background" quickstart](../../background_quickstart/) for an example of how to use this technique.

## Integration Patterns[¶](#integration-patterns "Permanent link")

LangMem's memory utilities are organized in two layers of integration patterns:

### 1. Core API[¶](#functional-core "Permanent link")
...
* [**Memory Managers**](../../reference/memory/#langmem.create_memory_manager): Extract new memories, update or remove outdated memories, and consolidate and generalize from existing memories based on new conversation information
* [**Prompt Optimizers**](../../reference/prompt_optimization/#langmem.create_prompt_optimizer): Update prompt rules and core behavior based on conversation information (with optional feedback)

These core functions do not depend on any particular database or storage system. You can use them in any application.

### 2. Stateful Integration[¶](#2-stateful-integration "Permanent link")
...
* [**Store Managers**](../../reference/memory/#langmem.create_memory_store_manager): Automatically persist extracted memories
* [**Memory Management Tools**](../../reference/tools/#langmem.create_manage_memory_tool): Give agents direct access to memory operations
...
## Storage System[¶](#storage-system "Permanent link")
...
### Memory Namespaces[¶](#memory-namespaces "Permanent link")
...
See [how to dynamically configure namespaces](../../guides/dynamically_configure_namespaces/) for an example, or the [NamespaceTemplate](../../reference/utils/#langmem.utils.NamespaceTemplate) reference docs for more details.

### Flexible Retrieval[¶](#flexible-retrieval "Permanent link")
