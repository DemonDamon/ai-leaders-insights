...
**来源**: [https://blog.csdn.net/weixin_43145427/article/details/140112854](https://blog.csdn.net/weixin_43145427/article/details/140112854)

---

# 大型语言模型的长期记忆能力--HippoRAG-CSDN博客

原文链接: https://blog.csdn.net/weixin_43145427/article/details/140112854
...
![在这里插入图片描述](ai-leaders-insights/核心能力与技术/记忆与学习/长期记忆/images/bf5718459b290d8a2b047d005e43b1f8.png)
...
1. **使用 LLM 进行 OpenIE**：从每个篇章中提取名词短语节点和关系边。
2. **构建知识图谱（KG）**：将提取的三元组整合成知识图谱，作为人工海马索引。
3. **使用检索编码器**：为 KG 中相似但不相同的名词短语添加额外的边，帮助下游模式完成。
4. **查询命名实体提取**：从查询中提取命名实体，并由检索编码器编码。
5. **PPR 算法**：在 KG 上运行个性化 PageRank（PPR）算法，通过查询节点的分布概率，实现上下文相关的检索。
...
![在这里插入图片描述](ai-leaders-insights/核心能力与技术/记忆与学习/长期记忆/images/b1322394a5c6e289f95a54bc06aed163.png)

---

*爬取时间: 2025-11-28 21:51:30*
