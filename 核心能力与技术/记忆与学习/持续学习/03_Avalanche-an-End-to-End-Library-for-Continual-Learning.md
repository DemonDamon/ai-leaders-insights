...
**来源**: [https://avalanche.continualai.org/](https://avalanche.continualai.org/)

---

# Avalanche: an End-to-End Library for Continual Learning | Avalanche

原文链接: https://avalanche.continualai.org/
...
![](ai-leaders-insights/核心能力与技术/记忆与学习/持续学习/images/1044ffd4e5ad0003ba3fe3e4ebcf245d.jpg)

**Avalanche** is an *End-to-End Continual Learning Library* based on [**PyTorch**](https://pytorch.org), born within [**ContinualAI**](https://www.continualai.org) with the goal of providing a **shared** and **collaborative** open-source (MIT licensed) **codebase** for *fast prototyping*, *training* and [*reproducible* *evaluation*](https://github.com/ContinualAI/reproducible-continual-learning) of continual learning algorithms.
...
*Avalanche* the first experiment of a **End-to-end Library** for [reproducible continual learning](https://github.com/ContinualAI/reproducible-continual-learning) research & development where you can find *benchmarks*, *algorithms,* *evaluation metrics* and much more, **in the same place**.
...
[Learn Avalanche in 5 Minutes](/getting-started/learn-avalanche-in-5-minutes)

We have also prepared for you a large set of ***examples & snippets*** you can plug-in directly into your code and play with:

<https://github.com/ContinualAI/avalanche/blob/master/docs/gitbook/broken-reference/README.md>
...
![](ai-leaders-insights/核心能力与技术/记忆与学习/持续学习/images/9dfd69aa2032ae4abe03c25ddd2f2e2f.jpg)

*Avalanche* is the flagship open-source collaborative project of [**ContinualAI**](https://www.continualai.org/#home): *a non profit research organization and the largest open community on Continual Learning for AI.*
...
We are always looking for new *awesome members* willing to join the *ContinualAI Lab*, so check out our [official website](https://www.continualai.org/lab/) if you want to learn more about us and our activities, or [contact us](/about-us/the-team#contacts).

Learn more about the [***Avalanche team and all the people who made it great***](/about-us/the-team)*!*

![](ai-leaders-insights/核心能力与技术/记忆与学习/持续学习/images/e72988a1ea8562ce81ebfd062ddfe78d.jpg)

[NextIntroduction](/getting-started/why-avalanche)

Was this helpful?

---

*爬取时间: 2025-11-28 21:51:14*
